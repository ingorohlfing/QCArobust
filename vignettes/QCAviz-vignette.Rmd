...
```{r}
ka_naive <- read.csv("ka_model_1_sim.csv")

#conditions
conds_upset(ka_naive$Configurations, nsets = 200)
config_upset_t(ka_naive$Configurations, nsets = 100)

conds_upset(ka_naive$Configurations, nsets = 162)
config_upset_t(ka_naive$Configurations, nsets = 87)
```
...
config_upset_t(model_6$Configurations, nsets = 600)
