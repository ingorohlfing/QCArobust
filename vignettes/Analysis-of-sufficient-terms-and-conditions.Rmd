...
The function `conditions_robust()` does the same as `configs_robust()` for single conditions. For example, the condition *ind* occurs in 33 solutions. In 27 solutions, *ind* cooccurs with *DEV* and *STA* and 6 times with *LIT*, *DEV* and *STA*.
