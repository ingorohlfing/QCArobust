...
```{r}
ka_naive <- read.csv("ka_model_1_sim_csv")

#conditions
conds_upset(ka_naive$Configurations, nsets = 200)
config_upset(ka_naive$Configurations, nsets = 100)

conds_upset(ka_naive$Configurations, nsets = 162)
config_upset(ka_naive$Configurations, nsets = 87)
```
...
config_upset(model_6$Configurations, nsets = 600)

```


Applying the functions for Böller Study
...
```{r}
config_upset(posinter$solution, nsets = 14) #does not work bc there is a sngl condition
config_upset(neginter$solution, nsets = 4)
config_upset(poscons$solution, nsets = 13)
config_upset(pospars$solution, nsets = 10) #does not work bc there is a sngl condition
config_upset(negcons$solution, nsets = 13)
config_upset(negpars$solution, nsets = 12)
```
...
```{r}
allsols <- rbind(posinter$solution, poscons$solution, pospars$solution, 
