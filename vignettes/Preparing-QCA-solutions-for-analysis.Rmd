...
```{r create-list}
sols_list <- list(sol1, sol2)
```

```{r}
QCArobust::solutions_robust(sols_list) # throws a warning
QCArobust::conditions_robust(sols_list) # error 
QCArobust::configurations_robust(sols_list) # error
