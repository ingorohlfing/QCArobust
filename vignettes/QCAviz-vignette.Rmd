...
The latest function has been added here too. 
```{r Skaaning csqca anchors sols}
sols_barplot(Skaaning_csanchors)
solutions_table_S(Skaaning_csanchors)
```
...
config_upset_t(model_1$Configurations, nsets = 378)
