...
solutions sohuld be plotted with the default being 5 (count always starts with
the most frequent solution). Solutions can get long and be too long for 
plotting on the axes. This is why the solutions are numbered in the plots.
