...
On the second, medium level of aggregation, the solutions are decomposed into their individual sufficient terms.  The `config_robust()` function decomposes solutions into its individual terms (also if the term is a single condition; usually it is a configuration) and produces an *Upset plot*.
...
The horizontal bars of an Upset plot summarize the frequency of a term across all solutions. The vertical bars summarize the *cooccurrence* of terms in solutions. 
