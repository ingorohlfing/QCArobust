...
#' which are obtained form the QCA solutions
#' @param y QCA solutions in their raw form
...
#' @return The function counts the configurations
#' and/or individual solutions depending on the plot
#' funciton used later. The output is presented in
...
#' conds_upset()
#'
#' Plot Function to chart conditions
#' intersection of the QCA output in a solution.
#'
#' @importFrom magrittr %>%
#' @import stringi
...
#' config_upset()
#'
#' Plot Function for the charting of configurations'
#' intersection of the QCA output in a solution.
#'
#' @importFrom magrittr %>%
#' @import stringi
...
#' intersection of the QCA output
#'
#' @importFrom magrittr %>%
#' @import stringi
#' @param df the data frame which has the
